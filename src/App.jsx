      ...
      <section id="solutions" className="section twoCols">
        ...
        <div className="copy">
          <div className="problemList">
            <p>Темп команды падает: заявки вязнут в переписках.</p>
            <p>Данные разбросаны по сервисам — одной картины нет.</p>
            <p>Вместо развития продукта день уходит на ручные повторения.</p>
            <p>Интерфейсы устарели и уже тормозят решения.</p>
          </div>
          <div className="chips">
          ...
          <p className="muted">Нужна единая цифровая система: быстрая, цельная, без лишнего шума.</p>
        </div>
      </section>
