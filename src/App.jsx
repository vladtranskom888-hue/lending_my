    ...
    <main>
      <section className="hero section">
        <p className="heroContactLine" aria-label="Контакты">
          ...
          <span aria-hidden="true">·</span>
          <a href="https://max.ru/u/f9LHodD0cOKS9xYTmSLkfkgBpXMKaRamsQiy41UzLuEw0LCihhQGztOrZtY" target="_blank" rel="noopener noreferrer">MAX</a>
          <span aria-hidden="true">·</span>
          <a href="mailto:vlsdtranskom888@gmail.com">Email</a>
        </p>
        <div className="copy">
          <p className="heroContactLine heroContactLineMobile" aria-label="Контакты">
            <a href="https://t.me/Vladkolikov" target="_blank" rel="noreferrer">Telegram</a>
            <span aria-hidden="true">·</span>
            <a href="https://wa.me/79147301976" target="_blank" rel="noreferrer">WhatsApp</a>
            <span aria-hidden="true">·</span>
      ...
      <section id="solutions" className="section twoCols">
        ...
        <div className="copy">
          <div className="problemList">
            ...
            <p>Интерфейсы перестают справляться с задачами.</p>
          </div>
